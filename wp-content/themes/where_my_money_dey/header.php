...
<link href="wp-content/themes/where_my_money_dey/images/favicon.ico" rel="shortcut icon">
<!--[if lt IE 9]>
...
function showRegionStats() {
	...
	<!-- Add jQuery library -->
	<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/fancybox//lib/jquery-1.9.0.min.js"></script>
...
<div id="page" class="hfeed site">
	...
	<header id="masthead" class="site-header" role="banner">
		<div id="header-logo" class="wrap">
			<h1>Where My <span>Money</span> Dey?</h1>
			<h2>All mining companies in Ghana are supposed to pay 3% of the revenues they generate back to local residents.</h2>
		</div>
	</header><!-- #masthead -->
